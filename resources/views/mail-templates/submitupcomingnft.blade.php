                        ...
                        <div style="padding-left:15px; padding-right:15px;">
                            <table style="width:100%">
                                ...
                                <tr class="content contain">
                                    ...
                                    <td style="word-break: break-all;">{{ $website ?? 'NaN' }}</td>
                                </tr>
                                <tr class="dummy-row">
                                    <td colspan="2"></td>
                                </tr>
                                ...
                                <tr class="content contain">
                                    <td>{{ $release_date ?? 'NaN' }}</td>
                                    <td>{{ $release_time ?? 'NaN' }}</td>
                                </tr>
                                <tr class="dummy-row">
                                    <td colspan="2"></td>
                                </tr>
                                ...
                                <tr class="content contain verify-message">
                                    <td colspan="2">
                                        Hello, Admin<br/>
                                        Kindly Verify this Upcoming NFTs, by using Click on below Link.<br/>
                                        <?php echo $link ?? 'NaN'; ?>
                                    </td>
                                </tr>
                                <tr class="dummy-row">
